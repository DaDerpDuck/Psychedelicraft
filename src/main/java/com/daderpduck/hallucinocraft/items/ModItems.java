...
public class ModItems {
    ...
    public static final RegistryObject<DrugBowlItem> SHROOM_STEW = registerItem("shroom_stew", () -> new DrugBowlItem(new DrugItem.Properties().addDrug(Drugs.RED_SHROOMS, 400, 0.2F, 6900).addDrug(Drugs.BROWN_SHROOMS, 400, 0.2F, 6900).food(ModFoods.SHROOM_STEW).stacksTo(1)));
    ...
    public static final RegistryObject<Item> HASH_MUFFIN = registerItem("hash_muffin", () -> new DrugItem(new DrugItem.Properties().addDrug(Drugs.CANNABIS, 800, 0.12F, 3200).food(ModFoods.HASH_MUFFIN)));
    public static final RegistryObject<DrugBottleItem> UNBREWED_CANNABIS_TEA = registerItem("unbrewed_cannabis_tea", () -> new DrugBottleItem(new DrugItem.Properties().stacksTo(16)));
    public static final RegistryObject<DrugBottleItem> CANNABIS_TEA = registerItem("cannabis_tea", () -> new DrugBottleItem(new DrugItem.Properties().addDrug(Drugs.CANNABIS, 800, 0.1F, 3200).food(ModFoods.CANNABIS_TEA).stacksTo(16)));
    ...
    public static final RegistryObject<Item> BONG = registerItem("bong", () -> new BongItem(new Item.Properties().durability(8).setNoRepair()));
...
//    public static final RegistryObject<Item> FERMENTING_BOTTLE = registerBlock("fermenting_bottle", ModBlocks.FERMENTING_BOTTLE_BLOCK);
    ...
    private static RegistryObject<DrugItem> registerDrug(String name, DrugChain drugChain, UseAnim useAction, int stackSize) {
        ...
        return registerItem(name, () -> new DrugItem(itemProperties.useAction(useAction).stacksTo(stackSize)));
    }
    ...
    private static RegistryObject<SyringeItem> registerSyringe(String name, DrugChain drugChain, int color) {
        ...
        return registerItem(name, () -> new SyringeItem(itemProperties.stacksTo(1)));
    }
    ...
    private static RegistryObject<JointItem> registerJoint(String name, DrugChain drugChain) {
        ...
        return registerItem(name, () -> new JointItem(itemProperties.useAction(UseAnim.BOW).stacksTo(16)));
    }
    ...
    private static <T extends Block> RegistryObject<Item> registerBlock(String name, RegistryObject<T> block, int stackSize) {
        return registerItem(name, () -> new ItemNameBlockItem(block.get(), new Item.Properties().stacksTo(stackSize)));
    }
    ...
    private static RegistryObject<Item> registerBottle(String name) {
        return registerItem(name, () -> new Item(new Item.Properties().stacksTo(16)) {
            @Override
    ...
    private static RegistryObject<Item> registerItem(String name, int stackSize) {
        return registerItem(name, () -> new Item(new Item.Properties().stacksTo(stackSize)));
    }
    ...
    public static void registerItemColors(RegisterColorHandlersEvent.Item event) {
        event.register(new SyringeItem.Color(), COCAINE_SYRINGE.get(), MORPHINE_SYRINGE.get(), SOUL_RESTER_SYRINGE.get(), SOUL_WRENCHER_SYRINGE.get());
    }
