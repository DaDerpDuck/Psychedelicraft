...
public class BrewRegistry {
    public static void register() {
        ...
        BrewingRecipeRegistry.addRecipe(StrictNBTIngredient.of(waterBottle), Ingredient.of(ModItems.SOUL_CONCENTRATE.get()), ModItems.SOUL_RESTER_BOTTLE.get().getDefaultInstance());
